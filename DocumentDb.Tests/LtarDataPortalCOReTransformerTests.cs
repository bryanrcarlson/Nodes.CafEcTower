...
namespace DocumentDb.Tests
{
    public class LtarDataPortalCOReTransformerTests
    {
        ...
        public void ToCOReContent_ValidData_ReturnsCorrectCORe()
        {
            ...
            // Act
            List<Observation> actual = sut.ToCOReObservations("CAF", "001", 'C', -8, getValidMeasurements());
        ...
        private List<Observation> getValidObservations()
        {
           ...
           {
               new Observation("CAF", "001", new DateTime(2017, 09, 05, 16, 0, 0), 'C', 27.80702m, 3.014338m, 125.9m, 22.4503m, 0, 93.33482m, 283.3229m, null, null, 13.01541m, 29.87764m)
           };
